...
import { AFX, ZERO_ADDRESS } from '../../constants'
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Africaswap Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  AFX tokens represent voting shares in Africaswap governance. You can vote on each proposal yourself or
